...
function reviewGate(records) {
  ...
  return {
    ...
    eligibleForChronicle: false,
    automaticChainWrite: false,
    requiredAction: 'A human reviewer must approve the sources and claims before an explicit Chronicle commit.',
  }
}
