...
export const KNOWLEDGE_TOPICS = Object.freeze({
  ai: topic({
    ...
    preferredDomains: ['openai.com', 'anthropic.com', 'microsoft.com', 'nvidia.com', 'kimi.com', 'moonshot.ai', 'nature.com', 'science.org', 'reuters.com', 'nytimes.com', 'cnbc.com', 'forbes.com'],
  ...
  finance: topic({
    ...
    queries: [
      ...
      'digital assets financial infrastructure official regulation Injective',
    ],
    preferredDomains: ['imf.org', 'bis.org', 'worldbank.org', 'federalreserve.gov', 'ecb.europa.eu', 'injective.com', 'reuters.com'],
