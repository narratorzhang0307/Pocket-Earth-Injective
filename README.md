...
- **一键验链**：本地运行 `npm run verify:injective`，会只读核验 `agentId 43–47`、`builderCode: pocket-earth`、`/api/injective` 读链路、ERC-8004 registry mint 事件、钱包证据链、Blockscout 页面和真实握手事件。
