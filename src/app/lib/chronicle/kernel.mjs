// FactAtlas Chronicle Kernel, adapted for Pocket Earth without UI or Atlas types.
// This module intentionally uses Web Crypto so the same proof code runs in Node and the browser.

export const KNOWLEDGE_CHAIN_SCHEMA = 'fact-atlas-chronicle/v1'
export const DAILY_EDITION_SCHEMA = 'fact-atlas-daily-edition/v1'
