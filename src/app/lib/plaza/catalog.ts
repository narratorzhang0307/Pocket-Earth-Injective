...
// 空间 Agent 广场货架。
// featured = 可「添加」的前瞻 agent（点添加 → installAgent → 进 AGENTS 入口的「我的 AGENT」）；
...
export const SPACE_AGENTS: SpaceAgent[] = [
  // ——— 精选 · 口播点名的前瞻例 ———
  {
    ...
    group: 'featured', reviewed: true, runTarget: 'daily-knowledge',
  },
  {
    ...
    runtime: 'hybrid', onChain: null, group: 'featured', reviewed: true,
  },
  {
    ...
    runtime: 'cloud', onChain: null, group: 'featured', reviewed: true,
  },
  {
    ...
    runtime: 'hybrid', onChain: null, group: 'featured', reviewed: true, runTarget: 'travel-agent',
  },
  {
    ...
    group: 'featured', reviewed: true,
  },
  // ——— 精选 agent（演示「添加」闭环：点添加即进 AGENTS 入口）———
  {
  ...
  },
  {
    ...
    spaceObject: 'sighting', permissions: { scopes: ['location', 'photos'], tools: ['edge_tag', 'geocode', 'mark_place'] },
    runtime: 'edge', onChain: null, group: 'featured', reviewed: true,
  },
  {
  ...
  // ——— 自带 · 已上架运行的真 agent（OPEN 直达；travel 只在精选段出现一次，这里不再列）———
  {
    ...
    runtime: 'hybrid', onChain: null, group: 'installed', reviewed: true, runTarget: 'music-agent',
  },
  {
    id: 'movies', name: '电影', tagline: '把电影钉到取景地 / 故事地', publisher: 'Pocket Earth 官方', emoji: '🎬', color: '#e0a02a',
    spaceObject: 'place', permissions: { scopes: ['network'], tools: ['enrich', 'geocode', 'mark_place'] },
    runtime: 'hybrid', onChain: null, group: 'installed', reviewed: true, runTarget: 'movies-agent',
  },
  {
    id: 'books', name: '读书', tagline: '把书钉到故事地 / 作者地 + 读完日期', publisher: 'Pocket Earth 官方', emoji: '📖', color: '#b388ff',
    spaceObject: 'place', permissions: { scopes: ['network'], tools: ['enrich', 'geocode', 'mark_place'] },
    runtime: 'hybrid', onChain: null, group: 'installed', reviewed: true, runTarget: 'books-agent',
  },
  {
    ...
    runtime: 'edge', onChain: null, group: 'installed', reviewed: true, runTarget: 'photos-agent',
  },
];
