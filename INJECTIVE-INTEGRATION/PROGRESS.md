...
- ✅ **集成说明防漂移守门**：`npm run verify:integration-guide` 已加入录屏前快检，固定 `INJECTIVE-INTEGRATION/README.md` 的 `/api/injective` 能力清单、API 端点表、命令序号和 npm 脚本映射；这轮也修掉了集成说明里重复的 `#14` 命令编号。
