...
assertListIncludes('evidence market landscape negative coordinate keys', (evidence.marketLandscapeBoundary.negativeCoordinates || []).map((item) => item.key), MARKET_LANDSCAPE_BOUNDARY.negativeCoordinates.map((item) => item.key))
assertTrue('evidence market landscape pure-social coordinate cites public-plaza', evidence.marketLandscapeBoundary.negativeCoordinates?.some((item) => item.key === 'pure-social' && item.examples?.includes('friend.tech') && item.examples?.includes('Farcaster') && item.pocketEarthBoundary.includes('public-plaza')))
...
assertFocusIncludes('evidence recording step 2', evidence.recordingOrder[1], 'SocialHandshake deployment transaction')
assertFocusIncludes('evidence recording step 2', evidence.recordingOrder[1], 'real handshake transaction')
assertFocusIncludes('evidence recording step 3', evidence.recordingOrder[2], 'registryMintSummary')
assertFocusIncludes('evidence recording step 3', evidence.recordingOrder[2], 'handshakeProof')
assertFocusIncludes('evidence recording step 3', evidence.recordingOrder[2], 'agentA/agentB/score/profileHash')
assertFocusIncludes('evidence recording step 3', evidence.recordingOrder[2], 'creation/runtime bytecode')
...
assertFocusIncludes('evidence recording step 6', evidence.recordingOrder[5], 'agentA/agentB/score/profileHash')
assertFocusIncludes('evidence recording step 6', evidence.recordingOrder[5], 'creation/runtime bytecode')
