...
try {
  ...
  expect(plazaText.includes('PUBLIC EARTH'), 'PUBLIC EARTH header missing')
  expect(plazaText.includes('PE-03-0043'), 'Public Earth on-chain doorplate missing')
  expect(plazaText.includes('LIVE · INJECTIVE'), 'Public Earth live chain state missing')
