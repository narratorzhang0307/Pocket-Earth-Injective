...
- review brief, reviewer checklist, competition alignment, submission links, submission checklist, and sourceControl wiring for public links, local proof commands, API-returned Blockscout link reachability, three-minute demo timing, followable recording order, plaza flow grouping, Nova story mapping, contest requirement coverage, current source commit anchoring, and final review entry points
