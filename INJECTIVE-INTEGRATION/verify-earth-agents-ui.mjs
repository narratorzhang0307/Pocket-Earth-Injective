...
assert.match(agents, /aria-expanded=\{isExpanded\}/)
assert.match(agents, /verification-trigger-/)
assert.match(agents, /verification-panel-/)
assert.match(agents, /current === agent\.id \? null : agent\.id/)
