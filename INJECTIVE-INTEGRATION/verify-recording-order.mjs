...
assertFocusIncludes('recording step 2', walletPage, 'SocialHandshake deployment transaction')
assertFocusIncludes('recording step 2', walletPage, 'real handshake transaction')
...
assertFocusIncludes('recording step 3', evidenceApi, 'handshakeProof')
assertFocusIncludes('recording step 3', evidenceApi, 'agentA/agentB/score/profileHash')
assertFocusIncludes('recording step 3', evidenceApi, 'creation/runtime bytecode')
...
assertFocusIncludes('recording step 6', timelineApi, 'agentA/agentB/score/profileHash')
assertFocusIncludes('recording step 6', timelineApi, 'creation/runtime bytecode')
...
assertFocusIncludes('recording step 7', hardwareProofApi, 'hardwareBridge.serviceBoundary')
assertFocusIncludes('recording step 7', hardwareProofApi, 'hardwareBridge.roadmapBoundary')
...
assertTrue('recording step 7 hardware proof roadmap boundary', String(hardwarePayload.hardwareBridge?.roadmapBoundary?.integrationRule || '').includes('optional/removable'))
...
assertEqual('recording step 7 hardware proof service boundary key', hardwarePayload.hardwareBridge?.serviceBoundary?.key, HARDWARE_BRIDGE_PROOF.serviceBoundary.key)
assertTrue('recording step 7 hardware proof service receipt slot', hardwarePayload.hardwareBridge?.serviceBoundary?.futureReceiptSlot?.includes('hardwareNodeServiceReceipt'))
assertTrue('recording step 7 hardware proof service Agent Plaza tie-in', hardwarePayload.hardwareBridge?.serviceBoundary?.agentPlazaTieIn?.includes('Agent Plaza service receipts'))
