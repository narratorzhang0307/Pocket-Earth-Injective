...
- SocialHandshake 合约：`0xe5338a162a44a685201e1f6120b1a851949e3aee`；`verify-handshake-contract.mjs` 会核验合约地址由比赛钱包 nonce 2 推导、代码在 Frost 注册后且握手前出现，并重新编译本仓库的 `SocialHandshake.sol` 比对 Injective testnet runtime bytecode。
